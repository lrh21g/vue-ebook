...
export default {
  ...
  data () {
    return {
      ifShowCancel: false, // 是否显示 取消
      ifShowClear: false, // 是否显示搜索框 清除搜索文本 icon
  ...
  computed: {
    tabs () {
      return [
        {
          id: 1,
          text: this.$t('shelf.default'), // 默认
          selected: true
        },
        {
          id: 2,
          text: this.$t('shelf.progress'), // 按进度
          selected: false
        },
        {
          id: 3,
          text: this.$t('shelf.purchase'), // 按购买
          selected: false
        }
      ]
    }
