  ...
  watch: {
    offsetY (v) {
      ...
      if (v >= this.height && v < this.threshold) {
        ...
        if (!this.isBookmark) { // 判断是否为书签页
          this.text = this.$t('book.pulldownAddMark') // 文本为：下拉添加书签
          this.color = WHITE
        } else {
          this.text = this.$t('book.pulldownDeleteMark') // 文本为：下拉删除书签
          this.color = BLUE
        }
        ...
        if (!this.isBookmark) {
          this.text = this.$t('book.releaseAddMark') // 文本为：松手添加书签
          this.color = BLUE
        } else {
          this.text = this.$t('book.releaseDeleteMark') // 文本为：松手删除书签
          this.color = WHITE
        }
